...
5. Classify: cluster center closer to reference sphere = UNWORN, other = WORN
...
**Date**: November 27, 2025 (Updated from GitHub import)

### Development Configuration
- **Workflow**: "Start application" runs `python server.py`
- **Port**: 5000 (frontend webview)
- **Host**: 0.0.0.0 (allows proxy access)
- **Python Version**: 3.12 (pre-installed in Replit)
...
```
.
├── index.html                          # Main application (~4380 lines, standalone)
